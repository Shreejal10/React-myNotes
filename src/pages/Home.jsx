    ...
    return (
        <div className='pt-16'>
            ...
            <div className=' container mx-auto flex items-center justify-around py-4 mt-6'>
                <button className='text-white text-xl bg-[#062f4e] px-2 py-1 rounded-xl flex items-center justify-center gap-2'><p>Add Note</p> < IoAddCircleOutline size={20} className="mt-1" /> </button>
